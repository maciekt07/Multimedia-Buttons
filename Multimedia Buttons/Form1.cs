...
namespace Multimedia_Buttons
{
    ...
    public partial class Form1 : Form
    {
        ...
        void Title()
        {
            ...
            if (proc != null)
            {
              if (proc.MainWindowTitle == "Advertisement") { button1.Visible = true; }
               else { button1.Visible = false; }
                if (proc.MainWindowTitle == "Spotify Free"){this.Text = "Multimedia Buttons By github.com/maciekkoks";}
                else if (proc.MainWindowTitle == "Spotify Premium") { this.Text = "Multimedia Buttons By github.com/maciekkoks"; }
                else
                {
